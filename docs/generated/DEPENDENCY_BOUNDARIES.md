...
| `RELATIONSHIP-026` | `egohygiene/hygiene` | `egohygiene/holon`, `egohygiene/relay`, `egohygiene/pace`, `egohygiene/store`, `egohygiene/observatory` | Agent-Ready Web vocabulary, discovery and efficient-representation catalog, guarded browser-capability envelope, descriptive commerce and advertising policy, source-equivalence and negotiation rules, maturity and evidence shape, compatibility, extension, and ownership policy | `schema`, `generated-projection` | _required_ | `versioned` |
