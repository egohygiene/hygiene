...
id: hygiene-design-system
title: Hygiene Design System
...
This document defines reusable semantic language for Hygiene's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain holistic, navigable, systems-oriented, and legible at multiple levels of detail while allowing product-specific identity to vary inside Ego Hygiene's broader family.
